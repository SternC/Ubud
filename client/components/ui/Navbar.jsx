...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`md:hidden absolute top-full left-2 right-0 p-4 bg-white/90 backdrop-blur-sm shadow-xl transition-all duration-300 ease-in-out transform rounded-xl border border-gray-200${
