...
export default function Hero() {
  return (
  <section className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#1c6ea4] via-[#154d71] to-[#000B58]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-6">
              <h1
                className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight text-balance opacity-0 animate-fade-in-up"
                style={{ color: "#FFFBDE" }}
              >
                Your Best
                <span className="block animate-fade-in-up animate-delay-200" style={{ color: "#FFFBDE" }}>
                  Study Buddy
                </span>
              </h1>
              <p
            ...
            <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in-up animate-delay-600">
                <Link to="/register">
                    <Button
                    size="lg"
                    className="group bg-[#F5F0CD] hover:bg-[#f5f091] text-[#154D71] px-10 py-4 text-lg font-bold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl animate-pulse-glow"
                    >
                    Get Started
            ...
            <div className="flex flex-col sm:flex-row gap-6 text-sm opacity-0 animate-slide-in-left animate-delay-600">
              {[
                ...
                <div key={i} className="flex items-center gap-3 group cursor-pointer">
                  <div className="w-6 h-6 bg-highlight text-primary rounded-full flex items-center justify-center text-xs font-bold transition-transform group-hover:scale-110">
                    {item.icon}
                  </div>
            ...
            <div className="flex justify-center lg:justify-start gap-6 pt-8 opacity-0 animate-fade-in-up animate-delay-600">
              {[
                { icon: BookOpen, label: "Literature", color: "bg-highlight/20 hover:bg-highlight/30" },
                { icon: Calculator, label: "Math", color: "bg-accent/20 hover:bg-accent/30" },
                { icon: Palette, label: "Arts", color: "bg-secondary/20 hover:bg-secondary/30" },
                { icon: Users, label: "Social", color: "bg-primary/20 hover:bg-primary/30" },
              ].map((subject, i) => (
          ...
          <div className="relative opacity-0 animate-fade-in-up animate-delay-400">
            {/* Water container with floating effect */}
            <div className="relative h-96 overflow-hidden">
              ...
              {/* Ubud app name floating in center */}
              <div className="absolute inset-0 flex items-center justify-center animate-water-float">
                <div className="text-center">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <div className="font-melody text-9xl font-bold tracking-wider" style={{ color: "#CBDCEB" }}>
            ...
            {/* Ambient glow effects around water container */}
