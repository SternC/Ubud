...
import { coachApply, getAllCoaches, approveCoach, rejectCoach, getCoaches } from "../controllers/coachController.js";

const router = express.Router();

router.post("/coach-apply", verifyToken, coachApply);
router.get("/coaches", verifyToken, getAllCoaches);
router.get("/coachesprofiles", verifyToken, getCoaches);
